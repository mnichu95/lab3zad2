...
public class LinkedListTest extends MyAbstract {
	
	static List<Account> humans = new LinkedList<Account>();
    private static final int LINKED_LIST_LENGTH = 500000;
RandomGenerator randomgenerator= new RandomGenerator();
	...
	public double timeTestAdding() {
		...
		for(int i=0; i<LINKED_LIST_LENGTH; i++) {
			humans.add(new Account(randomgenerator.generator.nextInt(1001),randomgenerator.generateRandomString()));
		}
